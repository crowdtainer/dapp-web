<footer class="bg-black">
	<div class="content-container pl-3 pr-3">
		<div class="px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 text-white">
			<div class="md:pb-16 lg:pb-0" />
			<div class="py-4 px-2 md:pb-16 lg:pb-0">
				<p class="text-gray-400 pb-2">Legal</p>
				<p class="pb-2">
					<a href="#" class="link">Impressum / Imprint</a>
				</p>
				<p class="pb-2">
					<a href="#" class="link">Geschäftsbedingungen (DE)</a>
				</p>
				<p class="pb-2">
					<a href="#" class="link">Terms & Conditions (EN)</a>
				</p>
				<p class="pb-2">
					<a href="#" class="link">Privacy Policy</a>
				</p>
			</div>
			<div class="py-4 px-2 pb-8 md:pb-0">
				<p class="text-gray-400 pb-2">Learn</p>
				<p class="pb-2">
					<a href="https://crowdtainer.io/post" class="link">Blog</a>
				</p>
				<p class="pb-2">
					<a
						href="https://github.com/crowdtainer/dapp-contracts/blob/main/docs/SystemDescription.md"
			...
			<div>
				...
				<div class="flex lg:flex-col">
					<div class="flex pb-3 mr-3 lg:mr-0">
						<a href="http://instagram.com/" class="mr-3 border-white">
							<svg
								role="img"
								width="32"
								height="32"
