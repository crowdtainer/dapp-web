				...
				<div class="p-8">
					...
					<div class="">
						...
						<div class="flex flex-wrap ml-0 mr-2">
							<p class=""><b>Raised:</b> 53.500,00 DAI</p>
						...
						<p class="my-3"><b>Minimum goal:</b> 100.000,00 DAI</p>
						<!-- Prices -->
						<div class="flex flex-wrap mb-4">
							...
							<div><p class="mx-2 text-green-700">20 USDC</p></div>
						<!-- </div>
						<div class="flex flex-wrap"> -->
							<div>
								<p><b>| 500g:</b></p>
							</div>
							<div><p class="mx-3 text-green-700">38 USDC</p></div>
						</div>
